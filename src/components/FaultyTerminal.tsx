...
export default function FaultyTerminal({
  ...
  mouseReact = true,
  mouseStrength = 0.2,
  // SSR-safe: do not read window in default param
  dpr: dprProp,
  ...
  useEffect(() => {
    ...
    const devicePixelRatio = dprProp ?? (typeof window !== "undefined" ? Math.min(window.devicePixelRatio || 1, 2) : 1);
    ...
    const update = (t: number) => {
      ...
      if (pageLoadAnimation && loadAnimationStartRef.current > 0) {
        ...
        (program.uniforms.uPageLoadProgress as { value: number }).value = progress;
      }
